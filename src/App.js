    ...
    return (
      <div style={{
        ...
        {funcName === 'hpcheck' && (
          <>
            <div>
              Target: <input type="text" value={funcData.target || ''} 
...
function Flow() {
  ...
  const availableFunctions = [
    ...
    // ... (rest of the functions array remains the same, just formatted)
    { 
    ...
    { 
      ...
      type: 'assignmentNode', 
      nodeColor: nodeColors['Value Assignment'],
      description: 'Assigns the result of a function to VALUE_0~VALUE_9 for later use.',
    }
  ];
